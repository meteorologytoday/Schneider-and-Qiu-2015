...
bottom_approx_op = spzeros(Ns+1, Ns)
...
τx_1_E_1_part_W[:, :, 1] = E_1_0 .* u_0_T[:, :, 1] ./ gd.z_T[:, :, 1]
τy_1_E_1_part_W[:, :, 1] = E_1_0 .* v_0_T[:, :, 1] ./ gd.z_T[:, :, 1]
